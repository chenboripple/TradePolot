...
def main():
    ...
    # 精简参数网格
    ma_configs = [(5, 20), (6, 20), (8, 25), (10, 30), (10, 35)]
    rsi_configs = [
    ...
    print(f"\n最优配置 (MA{best_config['ma'][0]}/{best_config['ma'][1]}, RSI{best_config['rsi'][0]}/{best_config['rsi'][1]}/{best_config['rsi'][2]}, BB{best_config['bb'][0]}/{best_config['bb'][1]}, 票=1):")
    ...
    for i, cfg in enumerate(all_results[:5], 1):
